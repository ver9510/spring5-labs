...
public interface PropertyMatcher extends Supplier<Properties> {
    ...
    @SneakyThrows
    static PropertyMatcher from(ExceptionalSupplier<InputStream, ?> inputStreamSupplier) {
        try (InputStream inputStream = inputStreamSupplier.getOrThrowUnchecked()) {
